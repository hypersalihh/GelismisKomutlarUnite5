...
public class MainActivity extends AppCompatActivity {
    ...
    public void  btSS_165 (View view){
        Intent uyg = new Intent(MainActivity.this, SS_165_Activity.class);
        startActivity(uyg);
    }
    public void  btSS_169 (View view){
        Intent uyg = new Intent(MainActivity.this, SS_169_Activity.class);
        startActivity(uyg);
    }
    public void  btSS_173 (View view){
        Intent uyg = new Intent(MainActivity.this, SS_173_Activity.class);
        startActivity(uyg);
    }
    public void  btSS_188 (View view){
        Intent uyg = new Intent(MainActivity.this, SS_188_Activity.class);
        startActivity(uyg);
    }
    public void  btSS_206 (View view){
